...
或者使用流畅的 xref::api/chatclient.adoc[ChatClient] API：
...
* xref:api/chat/azure-openai-chat.adoc#_multimodal[Azure Open AI（例如 GPT-4o 模型）]
* xref:api/chat/mistralai-chat.adoc#_multimodal[Mistral AI（例如 Mistral Pixtral 模型）]
* xref:api/chat/ollama-chat.adoc#_multimodal[Ollama（例如 LLaVA、BakLLaVA、Llama3.2 模型）]
* xref:api/chat/openai-chat.adoc#_multimodal[OpenAI（例如 GPT-4 和 GPT-4o 模型）]
* xref:api/chat/vertexai-gemini-chat.adoc#_multimodal[Vertex AI Gemini（例如 gemini-1.5-pro-001、gemini-1.5-flash-001 模型）]
